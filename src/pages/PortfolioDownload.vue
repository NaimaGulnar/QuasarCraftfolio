<template>
    <q-page class="row wrap justify-center items-center " :style="{background: 'linear-gradient(135deg, #060606, #525252)'}">
      <Suspense>
        <template #default>
      ...
      <section class="projects" id="projects">
        <div class="project-card">
          <div class="project-image">
                 ${imageBase64_1 ? `<img src="data:image/jpeg;base64,${imageBase64_1}" alt="${data.pName1}" class="project-img" />` : ''}
          </div>
          <div class="project-content">
            <h3 class="project-heading">${data.pName1}</h3>
            <p class="project-para">
               ${data.pDescription1}</p>
        ...
        <div class="project-card">
          <div class="project-image">
               ${imageBase64_2 ? `<img src="data:image/jpeg;base64,${imageBase64_2}" alt="${data.pName2}" class="project-img"/>` : ''}
          </div>
          <div class="project-content">
            <h3 class="project-heading">${data.pName2}</h3>
            <p class="project-para">
               ${data.pDescription2}</p>
            <div class="project-buttons">
              <a
